...
function RoleInfoLite_mt:ServerId()
...
function RoleInfoLite.Start(builder) builder:StartObject(4) end
...
function RoleInfoLite.AddServerId(builder, serverId) builder:PrependInt32Slot(3, serverId, 0) end
